...
> The installation is a bit different if you're already using Redux. **Please follow this guide _only_ if you're already using Redux.** If you're not please follow the [normal installation](../introduction/installation.md).
>
